<x-app-layout>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Tambah Tag Baru</h2>
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Isi detail tag untuk menambahkannya ke dalam sistem.</p>
        </div>
