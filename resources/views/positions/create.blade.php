<x-app-layout>
    <x-slot name="header">
        <div class="flex w-full flex-col gap-3">
            <h1 class="text-3xl font-semibold text-slate-900 dark:text-white">Tambah Posisi</h1>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <h2 class="text-xl font-semibold text-slate-900 dark:text-white">Form Posisi</h2>
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Masukkan detail posisi yang ingin ditambahkan.</p>
